...
"""Pure math helpers for finite-transition posterior alignment.

The primary objective is a one-step forward-KL projection of a reward-tilted
ASFMC transition posterior.  This module intentionally has no FastVideo
imports, so the probability math can be unit tested on CPU.
"""
