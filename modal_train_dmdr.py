...
DEFAULT_NUM_SAMPLES_PER_PROMPT = 16
DEFAULT_NUM_BATCHES_PER_EPOCH = 16
...
DEFAULT_SAMPLE_NUM_STEPS = 30
DEFAULT_SAMPLE_FLOW_SHIFT = 8.0
DEFAULT_SAMPLE_GUIDANCE_SCALE = 6.0
DEFAULT_VALIDATION_EVERY_STEPS = 5
DEFAULT_VALIDATION_NUM_STEPS = 30
DEFAULT_VALIDATION_NUM_PROMPTS = 8
DEFAULT_VALIDATION_BATCH_SIZE = 1
DEFAULT_NUM_FRAMES = 49
DEFAULT_NUM_LATENT_T = 0
DEFAULT_LOG_SAMPLE_MAX_VIDEOS = 8
